    ...
    def get(self):
        ...
        if app_id:
            installed_apps = (
                ...
                .join(App, InstalledApp.app_id == App.id).filter(and_(InstalledApp.tenant_id == current_tenant_id, InstalledApp.app_id == app_id, App.created_by == current_user_id))
                .all()
            )
        else:
            installed_apps = db.session.query(InstalledApp).join(App, InstalledApp.app_id == App.id).filter(InstalledApp.tenant_id == current_tenant_id, App.created_by == current_user_id).all()
